      ...
      <div style={cardStyle}>
        ...
        <div style={{ padding: '0 1.25rem 1.25rem' }}>
          ...
          <div style={{
            ...
            background: Number(ratio) >= 3 ? 'linear-gradient(135deg, #0D9488, #10B981)' : Number(ratio) >= 1 ? 'linear-gradient(135deg, #D97706, #F59E0B)' : 'linear-gradient(135deg, #DC2626, #EF4444)',
            color: 'white',
          }}>
