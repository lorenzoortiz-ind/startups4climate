...
export function PreIncubationIllustration({
  ...
  return (
    ...
    >
      ...
      />
      {/* Radiating lines */}
      <line x1="100" y1="12" x2="100" y2="22" stroke="#DA4E24" strokeWidth="2" strokeLinecap="round" />
      <line x1="140" y1="22" x2="135" y2="30" stroke="#DA4E24" strokeWidth="2" strokeLinecap="round" />
      <line x1="60" y1="22" x2="65" y2="30" stroke="#DA4E24" strokeWidth="2" strokeLinecap="round" />
      <line x1="162" y1="52" x2="154" y2="56" stroke="#DA4E24" strokeWidth="2" strokeLinecap="round" />
      <line x1="38" y1="52" x2="46" y2="56" stroke="#DA4E24" strokeWidth="2" strokeLinecap="round" />
      <line x1="168" y1="80" x2="158" y2="80" stroke="#DA4E24" strokeWidth="2" strokeLinecap="round" />
      <line x1="32" y1="80" x2="42" y2="80" stroke="#DA4E24" strokeWidth="2" strokeLinecap="round" />
      {/* Small seedling at base */}
      <path d="M100 172L100 182" stroke="#1F77F6" strokeWidth="2" strokeLinecap="round" />
      <path
...
export function IncubationIllustration({
  ...
  return (
    ...
    >
      ...
      />
      {/* Bubbles */}
      <circle cx="85" cy="145" r="4" stroke="#1F77F6" strokeWidth="1.5" fill="none" />
      <circle cx="110" cy="155" r="3" stroke="#1F77F6" strokeWidth="1.5" fill="none" />
      <circle cx="95" cy="160" r="2.5" stroke="#1F77F6" strokeWidth="1.5" fill="none" />
      {/* Plant growing inside flask */}
      <path d="M100 130L100 90" stroke="#1F77F6" strokeWidth="2" strokeLinecap="round" />
      <path
      ...
      <line x1="32" y1="58" x2="36" y2="54" stroke="#1F77F6" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="36" y1="54" x2="40" y2="56" stroke="#1F77F6" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="40" y1="56" x2="48" y2="52" stroke="#1F77F6" strokeWidth="1.5" strokeLinecap="round" />
      {/* Data points — bar chart right */}
      <rect x="148" y="60" width="24" height="16" rx="3" stroke="#1a1a1a" strokeWidth="1.5" fill="none" />
      <line x1="152" y1="72" x2="152" y2="66" stroke="#1F77F6" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="157" y1="72" x2="157" y2="64" stroke="#1F77F6" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="162" y1="72" x2="162" y2="68" stroke="#1F77F6" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="167" y1="72" x2="167" y2="63" stroke="#1F77F6" strokeWidth="1.5" strokeLinecap="round" />
      {/* Small dots */}
      <circle cx="35" cy="85" r="2" fill="#1F77F6" fillOpacity={0.4} />
      <circle cx="165" cy="42" r="2" fill="#1F77F6" fillOpacity={0.4} />
      <circle cx="155" cy="95" r="2" fill="#1F77F6" fillOpacity={0.4} />
    </svg>
  )
}
...
export function ScalingIllustration({
  ...
  return (
    ...
    >
      {/* Globe */}
      <circle cx="100" cy="100" r="70" stroke="#1a1a1a" strokeWidth="2.5" fill="#1F77F6" fillOpacity={0.06} />
      ...
      <circle cx="72" cy="72" r="6" stroke="#1F77F6" strokeWidth="2" fill="#1F77F6" fillOpacity={0.2} />
      <circle cx="130" cy="80" r="6" stroke="#1F77F6" strokeWidth="2" fill="#1F77F6" fillOpacity={0.2} />
      <circle cx="90" cy="120" r="6" stroke="#1F77F6" strokeWidth="2" fill="#1F77F6" fillOpacity={0.2} />
      <circle cx="140" cy="115" r="6" stroke="#1F77F6" strokeWidth="2" fill="#1F77F6" fillOpacity={0.2} />
      <circle cx="65" cy="105" r="6" stroke="#1F77F6" strokeWidth="2" fill="#1F77F6" fillOpacity={0.2} />
      <circle cx="108" cy="60" r="6" stroke="#1F77F6" strokeWidth="2" fill="#1F77F6" fillOpacity={0.2} />
      <circle cx="115" cy="140" r="6" stroke="#1F77F6" strokeWidth="2" fill="#1F77F6" fillOpacity={0.2} />
      {/* Network connection lines */}
      <line x1="72" y1="72" x2="130" y2="80" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="72" y1="72" x2="90" y2="120" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="72" y1="72" x2="108" y2="60" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="130" y1="80" x2="140" y2="115" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="130" y1="80" x2="108" y2="60" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="90" y1="120" x2="140" y2="115" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="90" y1="120" x2="65" y2="105" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="90" y1="120" x2="115" y2="140" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="140" y1="115" x2="115" y2="140" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="65" y1="105" x2="72" y2="72" stroke="#1F77F6" strokeWidth="1.5" opacity={0.5} />
      <line x1="108" y1="60" x2="115" y2="140" stroke="#1F77F6" strokeWidth="1.5" opacity={0.3} />
      {/* Outer orbiting dots */}
      <circle cx="28" cy="50" r="3" fill="#1F77F6" fillOpacity={0.4} />
      <circle cx="172" cy="55" r="3" fill="#1F77F6" fillOpacity={0.4} />
      <circle cx="20" cy="130" r="3" fill="#1F77F6" fillOpacity={0.4} />
      <circle cx="180" cy="140" r="3" fill="#1F77F6" fillOpacity={0.4} />
      {/* Dashed lines to outer dots */}
      <line x1="28" y1="50" x2="72" y2="72" stroke="#1F77F6" strokeWidth="1" strokeDasharray="3 3" opacity={0.3} />
      <line x1="172" y1="55" x2="130" y2="80" stroke="#1F77F6" strokeWidth="1" strokeDasharray="3 3" opacity={0.3} />
      <line x1="20" y1="130" x2="65" y2="105" stroke="#1F77F6" strokeWidth="1" strokeDasharray="3 3" opacity={0.3} />
      <line x1="180" y1="140" x2="140" y2="115" stroke="#1F77F6" strokeWidth="1" strokeDasharray="3 3" opacity={0.3} />
    </svg>
  )
}
...
export function ToolIllustration({
  ...
  return (
    ...
    >
      ...
      {/* Checkmark boxes */}
      <rect x="72" y="70" width="10" height="10" rx="2" stroke="#1F77F6" strokeWidth="1.5" fill="none" />
      <path d="M74 75L77 78L80 72" stroke="#1F77F6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <rect x="72" y="85" width="10" height="10" rx="2" stroke="#1F77F6" strokeWidth="1.5" fill="none" />
      <path d="M74 90L77 93L80 87" stroke="#1F77F6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      {/* Document lines */}
      ...
      <g transform="translate(38 120) rotate(-45)">
        <path
          ...
          fillOpacity={0.12}
        />
        <rect x="10" y="4" width="40" height="8" rx="1" stroke="#1a1a1a" strokeWidth="2" fill="#1F77F6" fillOpacity={0.08} />
        <path
      ...
      {/* Small gear accent */}
      <circle cx="158" cy="150" r="14" stroke="#1F77F6" strokeWidth="2" fill="#1F77F6" fillOpacity={0.1} />
      <circle cx="158" cy="150" r="6" stroke="#1F77F6" strokeWidth="2" fill="none" />
      {/* Gear teeth */}
