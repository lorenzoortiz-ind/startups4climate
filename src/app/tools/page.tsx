  ...
  const inner = (
    <motion.div
      ...
      style={{
        ...
        borderTop: `1px solid ${done ? tool.stageBorder : 'var(--color-border)'}`,
        borderRight: `1px solid ${done ? tool.stageBorder : 'var(--color-border)'}`,
        borderBottom: `1px solid ${done ? tool.stageBorder : 'var(--color-border)'}`,
