      ...
      <div style={cardStyle}>
        ...
        <div style={{ padding: '0 1.25rem 1.25rem' }}>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.6875rem', textTransform: 'uppercase', letterSpacing: '0.05em', opacity: 0.8, marginBottom: '0.375rem' }}>
              TAM Calculado
            </div>
            <div style={{ fontFamily: 'var(--font-heading)', fontSize: '2rem', fontWeight: 800, letterSpacing: '-0.02em' }}>
              ${tam.toLocaleString()}
            </div>
