...
import { Building2, LayoutDashboard, Users, FileText, ArrowRight, CheckCircle2, ChevronRight } from 'lucide-react'
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: '0.75rem 2rem' }}>
              {BENEFITS.map((benefit) => (
                ...
                >
                  <CheckCircle2 size={16} color="var(--color-accent-secondary)" style={{ flexShrink: 0 }} />
                  <span
                    style={{
                      fontFamily: 'var(--font-body)',
                      fontSize: '0.875rem',
